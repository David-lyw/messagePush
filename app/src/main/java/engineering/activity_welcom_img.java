 ...
 */
public class activity_welcom_img extends Activity implements OnClickListener {
    ...
    private int pageSize = imageResIds.length;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_welcom_img);
        initView();
        initData();
        initListener();
            ...
            if (i == 4) {//为最后一张添加touch监听，并实现响应事件。
                imageViews[i].setOnTouchListener(new OnTouchListener() {
                    ...
                    public boolean onTouch(View view, MotionEvent motionEvent) {
                        screenManager.pushActivity(activity_welcom_img.this);
                        Intent intent = new Intent(activity_welcom_img.this, activity_index.class);
